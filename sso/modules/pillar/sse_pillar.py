...
def _get_cursor():
    ...
    ssl_options = {}
    if __opts__.get('ssl_ca'):
        ssl_options['ca'] = __opts__.get('ssl_ca')

    if __opts__.get('ssl_cert'):
        ssl_options['cert'] = __opts__.get('ssl_cert')

    if __opts__.get('ssl_key'):
        ssl_options['key'] = __opts__.get('ssl_key')

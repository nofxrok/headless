...
["ent/app-stacks.html","Application Stacks","Application Stacks Salt State system Salt Orchestrate Salt Mine Hadoop cluster Custer FS Multi‐server stacks Multi-server deployments Data exchange Ordered deployment Next Copyright &#169; 2015 SaltStack. ",""],
["ent/architecture.html","Architecture Reference","Architecture Reference The following diagram provides an overview of how SaltStack Ops integrates with your SaltStack infrastructure: File System Paths Network Ports Web Console Database Network Ports Package Dependencies Next Copyright &#169; 2015 SaltStack. ",""],
["ent/best-practices.html","Best Practices","Best Practices Continuous Deployment Application Stacks Cloud Management Security Best Practices Next Copyright &#169; 2015 SaltStack. ",""],
["ent/cfg-masters.html","Manage Masters","Manage Masters Next Copyright &#169; 2015 SaltStack. ",""],
["ent/cfg-users.html","User Accounts","User Accounts Next Copyright &#169; 2015 SaltStack. ",""],
...
["ent/cloud.html","Cloud Management","Cloud Management Installing Salt Cloud Configure Profiles and Providers Querying cloud providers Deploying VMs Deploying groups of VMs using Cloud Maps Provider‐Specific Commands Scale infrastructure Orchestration Next Copyright &#169; 2015 SaltStack. ",""],
["ent/components.html","SaltStack Components","SaltStack Components Execution Modules States Grains Pillar Mine Reactor Returners Runners Custom Exection Modules Next Copyright &#169; 2015 SaltStack. ",""],
...
["ent/continuous-deployment.html","Continuous Deployment","Continuous Deployment Learn how to use Salt to manage and maintain continuous integrations. Git integration Jenkins continuous integration Travis continuous integration Next Copyright &#169; 2015 SaltStack. ",""],
["ent/dep-process.html","Getting Started","SaltStack Ops is designed to use your existing SaltStack environment. The following sections walk you through the deployment process.",""],
["ent/deployment.html","Deployment","Instructions to install additional physical, cloud, or virtual minions, and to deploy an entire SaltStack implementation.",""],
["ent/events-reactors.html","Event System and Salt Reactors","Event System and Salt Reactors Salt Event System Reactor System Next Copyright &#169; 2015 SaltStack. ",""],
["ent/faq.html","Frequently Asked Questions","Frequently Asked Questions Next Copyright &#169; 2015 SaltStack. ",""],
["ent/fundamentals.html","Salt Fundamentals","Salt Fundamentals SaltStack Components Targeting Minions Storing Static Data in the Pillar The Salt Mine Salt Best Practices Next Copyright &#169; 2015 SaltStack. ",""],
["ent/gui.html","Using the Enterprise GUI","Using the Enterprise GUI View Masters SaltStack Ops let&#39;s you connect multiple masters and view all connected minons in a single view. This lets you deploy jobs to all minions even if they are connected to different masters. View Minions All minions connected to any master are displayed in the m...",""],
["ent/jobs-all.html","Manage Jobs","Manage Jobs Next Copyright &#169; 2015 SaltStack. ",""],
["ent/jobs.html","Jobs","Deply a Salt Sate file (sls) or send a command to selected minions.",""],
["ent/masters.html","View Masters","SaltStack Ops let&#39;s you connect multiple masters and view all connected minons in a single view. This lets you deploy jobs to all minions even if they are connected to different masters.",""],
["ent/minions.html","View Minions","All minions connected to any master are displayed in the minion view along with status and configuration.",""],
["ent/orchestrate.html","Orchestration","Orchestration Automate infrastructure operations using Salt Orchestrate. Running ordered operations Operations across multiple systems Running operations based on results of previous operations Operations on minions, masters, start VMs Next Copyright &#169; 2015 SaltStack. ",""],
["ent/orchestration.html","Orchestration","Orchestration Salt Runners Beacons Next Copyright &#169; 2015 SaltStack. ",""],
["ent/remote-execution.html","Remote Execution","Remote Execution Remote execution tutorial Execution Modules Next Copyright &#169; 2015 SaltStack. ",""],
["ent/reports.html","View Reports","View Reports Report data is filtered by the selected group. Report Description Next Copyright &#169; 2015 SaltStack. ",""],
["ent/requirements.html","System Requirements","System Requirements Hardware Requirements Database and web console on same system: 2 GB RAM Web console only: 1 GB RAM Database only: 1 GB RAM Supported Operating Systems Ubuntu 14.04 RHEL Supported Browsers Modern versions of the following major browsers are supported to access the web console:...",""],
["ent/security-bp.html","Security Best Practices","Security Best Practices Access controls PKI directory - make sure this is secure - group ownership and permissions so unauthorized people can&#39;t get these Secure targeting (targeting via grains is not as secure - grains can be set by anyone - these can be faked) Publish runner - you can grant too...",""],
["ent/t_master_prepare.html","Preparing Masters for SaltStack Ops Integration","Prepare your Salt Masters for integration.",""],
["ent/t_ops_prepare.html","Preparing the SaltStack Ops System","Prepare the system that will host the SaltStack Ops Enterprise GUI.",""],
["ent/targets.html","Targets","Targets Quick Target Quick Target Saved Targets Saved Targets Next Copyright &#169; 2015 SaltStack. ",""],
["ent/user-auth.html","Authentication","Authentication Client ACL system Access Control System External Authentication System Next Copyright &#169; 2015 SaltStack. ",""],
["ent/web-console.html","Console Overview","Console Overview Next Copyright &#169; 2015 SaltStack. ",""],
...
["gs/formulas.html","SaltStack Formulas - QuickStart Guide","SaltStack Enterprise Quick Start Guide Demo Environment Install Execute Commands Define Configurations Create Formulas Target Systems Apply States Next Steps Create Formulas You&#39;ll learn how to: Define a repeatable, customized definition of a management task Insert system specific variables into...",""],
["gs/install.html","SaltStack Installation - QuickStart Guide","SaltStack Enterprise quick start guide Demo Environment Install Execute Commands Define Configurations Create Formulas Target Systems Apply States Next Steps Install SaltStack You&#39;ll learn how to: Install SaltStack View and accept connections from managed systems Send a test command to all manag...",""],
["gs/next.html","SaltStack Next Steps - QuickStart Guide","SaltStack Enterprise Quick Start Guide Demo Environment Install Execute Commands Define Configurations Create Formulas Target Systems Apply States Next Steps Next Steps Scheduling Troubleshooting, Logging ",""],
["gs/overview.html","SaltStack Overview - QuickStart Guide","SaltStack Enterprise quick start guide Overview Demo Environment Install Execute Commands Define Configurations Create Formulas Target Systems Apply States Next Steps What is SaltStack? SaltStack is a new approach to infrastructure management. SaltStack is simple enough to get running in minutes...",""],
["gs/remotex.html","SaltStack Remote Execution - QuickStart Guide","SaltStack Enterprise quick start guide Demo Environment Install Execute Commands Define Configurations Create Formulas Target Systems Apply States Next Steps Execute Commands You&#39;ll learn how to: Remotely execute shell commands on managed systems Remotely execute Salt commands on managed systems...",""],
["gs/highstate.html","SaltStack States - QuickStart Guide","SaltStack Enterprise Quick Start Guide Demo Environment Install Execute Commands Define Configurations Create Formulas Target Systems Apply States Next Steps States States A state is what happens when you apply a formula to a target. States can be applied directly from the command line: Or in th...",""],
["gs/targeting.html","SaltStack Targets - QuickStart Guide","SaltStack Enterprise Quick Start Guide Demo Environment Install Execute Commands Define Configurations Create Formulas Target Systems Apply States Next Steps Targeting You&#39;ll learn how to: Define a target to assign a formula to one or more systems. Use system data to define a target. Use custom,...",""],
["gs/top.html","SaltStack Top File - QuickStart Guide","SaltStack Enterprise quick start guide Demo Environment Install Execute Commands Define Configurations Create Formulas Target Systems Apply States Next Steps Define System Configurations You&#39;ll learn how to: Create a top file to match systems with unique configurations Estimated time: 15 minutes...",""],
...
["ref/auth/all/salt.auth.auto.html","salt.auth.auto","salt.auth.auto An \"Always Approved\" eauth interface to test against, not intended for production use auth Syntax salt.auth.auto.auth( username, password ) Details Authenticate! Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/auth/all/salt.auth.yubico.html","salt.auth.yubico","salt.auth.yubico Provide authentication using YubiKey To get your YubiKey API key you will need to visit the website below. https://upgrade.yubico.com/getapikey/ The resulting page will show the generated Client ID (aka AuthID or API ID) and the generated API key (Secret Key). Make a note of bot...",""],
["ref/auth-modules.html","Authentication Modules (salt.auth)","Authentication Modules (salt.auth) salt.auth.auto salt.auth.django salt.auth.keystone salt.auth.ldap salt.auth.mysql salt.auth.pam salt.auth.pki salt.auth.stormpath_mod salt.auth.yubico Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/beacons/all/salt.beacons.wtmp.html","salt.beacons.wtmp","salt.beacons.wtmp Beacon to fire events at login of users as registered in the wtmp file beacons: wtmp: {} beacon Syntax salt.beacons.wtmp.beacon( config ) Details Read the last wtmp file and return information on the logins beacons: wtmp: {} Next Copyright &#169; 2015 SaltStack. ",""],
["ref/beacons.html","Beacons (salt.beacons)","Beacons (salt.beacons) salt.beacons.inotify salt.beacons.journald salt.beacons.twilio_txt_msg salt.beacons.wtmp Next Copyright &#169; 2015 SaltStack. ",""],
["ref/cli/salt-api.html","salt-api","salt-api Start interfaces used to remotely connect to the salt master Synopsis salt-api Description The Salt API system manages network api connectors for the Salt Master Options -h, --help Details Print a usage message briefly summarizing these command-line options. -C CONFIG, --config=CONFIG D...",""],
["ref/cli/salt-call.html","salt-call","salt-call Synopsis Description Options Next Copyright &#169; 2015 SaltStack. ",""],
["ref/cli/salt-cloud.html","salt-cloud","salt-cloud Provision virtual machines in the cloud with Salt Next Copyright &#169; 2015 SaltStack. ",""],
["ref/cli/salt-cp.html","salt-cp","salt-cp Copy a file to a set of systems Next Copyright &#169; 2015 SaltStack. ",""],
["ref/cli/salt-key.html","salt-key","salt-key Next Copyright &#169; 2015 SaltStack. ",""],
["ref/cli/salt-master.html","salt-master","salt-master The Salt master daemon, used to control the Salt minions Next Copyright &#169; 2015 SaltStack. ",""],
["ref/cli/salt-minion.html","salt-minion","salt-minion The Salt minion daemon, receives commands from a remote Salt master. Next Copyright &#169; 2015 SaltStack. ",""],
["ref/cli/salt-run.html","salt-run","salt-run Execute a Salt runner Next Copyright &#169; 2015 SaltStack. ",""],
["ref/cli/salt-ssh.html","salt-ssh","salt-ssh Next Copyright &#169; 2015 SaltStack. ",""],
["ref/cli/salt-syndic.html","salt-syndic","salt-syndic The Salt syndic daemon, a special minion that passes through commands from a higher master Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/cli/sub_salt-call_description.html","Description","Description",""],
["ref/cli/sub_salt-call_options.html","Options","Options --version Details Print the version of Salt that is running. --versions-report Details Show program&#39;s dependencies and version number, and then exit -h, --help Details Show the help message and exit -c CONFIG_DIR, --config-dir=CONFIG_dir Details The location of the Salt configuration dir...",""],
["ref/cli/sub_salt-call_synopsis.html","Synopsis","Synopsis salt-call [options] Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/clouds/all/salt.cloud.clouds.linodepy.html","salt.cloud.clouds.linodepy","salt.cloud.clouds.linodepy Next Copyright &#169; 2015 SaltStack. ",""],
["ref/clouds/all/salt.cloud.clouds.lxc.html","salt.cloud.clouds.lxc","salt.cloud.clouds.lxc Install Salt on an LXC Container New in version 2014.7.0. Please read core config documentation . avail_images Syntax salt.cloud.clouds.lxc.avail_images( ) Details create Syntax salt.cloud.clouds.lxc.create( vm_, call=None ) Details Create an lxc Container. This function is...",""],
...
["ref/engines.html","Engines (salt.engines)","Engines (salt.engines) Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/fileserver.html","Fileserver (salt.fileserver)","Fileserver (salt.fileserver) salt.fileserver.gitfs salt.fileserver.hgfs salt.fileserver.minionfs salt.fileserver.roots salt.fileserver.s3fs salt.fileserver.svnfs Next Copyright &#169; 2015 SaltStack. ",""],
["ref/log.html","Log Handlers (salt.log)","Log Handlers (salt.log) Logstash Logging Handler Sentry Logging Handler Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/modules/all/salt.modules.artifactory.html","salt.modules.artifactory","salt.modules.artifactory Module for fetching artifacts from Artifactory Exception: ArtifactoryError Syntax salt.modules.artifactory.ArtifactoryError( value ) Details get_latest_snapshot Syntax salt.modules.artifactory.get_latest_snapshot( artifactory_url, repository, group_id, artifact_id, packa...",""],
...
["ref/modules/all/salt.modules.drbd.html","salt.modules.drbd","salt.modules.drbd DRBD administration module overview Syntax salt.modules.drbd.overview( ) Details Show status of the DRBD devices CLI Example: salt &#39;*&#39; drbd.overview Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/modules/all/salt.modules.fsutils.html","salt.modules.fsutils","salt.modules.fsutils Run-time utilities Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/modules/all/salt.modules.guestfs.html","salt.modules.guestfs","salt.modules.guestfs Interact with virtual machine images via libguestfs depends libguestfs mount Syntax salt.modules.guestfs.mount( location, access=&#39;rw&#39; ) Details Mount an image CLI Example: salt &#39;*&#39; guest.mount /srv/images/fedora.qcow Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/modules/all/salt.modules.junos.html","salt.modules.junos","salt.modules.junos Module for interfacing to Junos devices ALPHA QUALITY code. commit Syntax salt.modules.junos.commit( ) Details diff Syntax salt.modules.junos.diff( ) Details facts_refresh Syntax salt.modules.junos.facts_refresh( ) Details Reload the facts dictionary from the device. Usually o...",""],
...
["ref/modules/all/salt.modules.pam.html","salt.modules.pam","salt.modules.pam Support for pam read_file Syntax salt.modules.pam.read_file( file_name ) Details This is just a test function, to make sure parsing works CLI Example: salt &#39;*&#39; pam.read_file /etc/pam.d/login Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/modules/all/salt.modules.reg.html","salt.modules.reg","salt.modules.reg Manage the registry on Windows depends winreg Python module Registry Class Syntax salt.modules.reg.Registry Details Delay &#39;_winreg&#39; usage until this module is used create_key Syntax salt.modules.reg.create_key( hkey, path, key, value=None, reflection=True ) Details Create a regi...",""],
["ref/modules/all/salt.modules.rest_package.html","salt.modules.rest_package","salt.modules.rest_package Service support for the REST example install Syntax salt.modules.rest_package.install( name=None, refresh=False, fromrepo=None, pkgs=None, sources=None, **kwargs ) Details installed Syntax salt.modules.rest_package.installed( name, version=None, refresh=False, fromrepo=...",""],
["ref/modules/all/salt.modules.rest_sample.html","salt.modules.rest_sample","salt.modules.rest_sample Module for interfacing to the REST example pre-pre-ALPHA QUALITY code. grains_refresh Syntax salt.modules.rest_sample.grains_refresh( ) Details Refresh the cache. ping Syntax salt.modules.rest_sample.ping( ) Details Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/modules/all/salt.modules.riak.html","salt.modules.riak","salt.modules.riak Riak Salt Module Next Copyright &#169; 2015 SaltStack. ",""],
["ref/modules/all/salt.modules.rpm.html","salt.modules.rpm","salt.modules.rpm Support for rpm diff Syntax salt.modules.rpm.diff( package, path ) Details Return a formatted diff between current file and original in a package. NOTE: this function includes all files (configuration and not), but does not work on binary content. Arguments Details Value Descrip...",""],
...
["ref/modules/all/salt.modules.saltcloudmod.html","salt.modules.saltcloudmod","salt.modules.saltcloudmod Control a salt cloud system create Syntax salt.modules.saltcloudmod.create( name, profile ) Details Create the named vm CLI Example: salt saltcloud.create webserver rackspace_centos_512 Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/modules/all/salt.modules.test_virtual.html","salt.modules.test_virtual","salt.modules.test_virtual Module for running arbitrary tests with a __virtual__ function ping Syntax salt.modules.test_virtual.ping( ) Details Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/modules/all/salt.modules.vbox_guest.html","salt.modules.vbox_guest","salt.modules.vbox_guest VirtualBox Guest Additions installer additions_install Syntax salt.modules.vbox_guest.additions_install( *args, **kwargs ) Details Install VirtualBox Guest Additions. Uses the CD, connected by VirtualBox. To connect VirtualBox Guest Additions via VirtualBox graphical inte...",""],
...
["ref/modules/all/salt.modules.win_disk.html","salt.modules.win_disk","salt.modules.win_disk Module for gathering disk information on Windows depends win32api Python module usage Syntax salt.modules.win_disk.usage( ) Details Return usage information for volumes mounted on this minion CLI Example: salt &#39;*&#39; disk.usage Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/modules/all/salt.modules.win_update.html","salt.modules.win_update","salt.modules.win_update Module for running windows updates. depends win32com win32con win32api pywintypes New in version 2014.7.0. PyWinUpdater Class Syntax salt.modules.win_update.PyWinUpdater Details download_updates Syntax salt.modules.win_update.download_updates( includes=None, retries=5, ca...",""],
...
["ref/output/all/salt.output.key.html","salt.output.key","salt.output.key Display salt-key output The salt-key command makes use of this outputter to format its output. output Syntax salt.output.key.output( data ) Details Read in the dict structure generated by the salt key API methods and print the structure. Next Copyright &#169; 2015 SaltStack. ",""],
["ref/output/all/salt.output.nested.html","salt.output.nested","salt.output.nested Recursively display nested data This is the default outputter for most execution functions. Example output: myminion: ---------- foo: ---------- bar: baz dictionary: ---------- abc: 123 def: 456 list: - Hello - World NestDisplay Class Syntax salt.output.nested.NestDisplay Deta...",""],
...
["ref/output/all/salt.output.no_out.html","salt.output.no_out","salt.output.no_out Display no output No output is produced when this outputter is selected output Syntax salt.output.no_out.output( ret ) Details Don&#39;t display data. Used when you only are interested in the return. Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/output/all/salt.output.virt_query.html","salt.output.virt_query","salt.output.virt_query virt.query outputter Used to display the output from the virt.query runner. output Syntax salt.output.virt_query.output( data ) Details Display output for the salt-run virt.query function Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/pillar/all/salt.pillar.hiera.html","salt.pillar.hiera","salt.pillar.hiera Use hiera data as a Pillar source ext_pillar Syntax salt.pillar.hiera.ext_pillar( minion_id, pillar, conf ) Details Execute hiera and return the data Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/pillar/all/salt.pillar.varstack_pillar.html","salt.pillar.varstack_pillar","salt.pillar.varstack_pillar Use varstack data as a Pillar source ext_pillar Syntax salt.pillar.varstack_pillar.ext_pillar( minion_id, pillar, conf ) Details Parse varstack data and return the result Next Copyright &#169; 2015 SaltStack. ",""],
["ref/pillar/all/salt.pillar.virtkey.html","salt.pillar.virtkey","salt.pillar.virtkey Accept a key from a hypervisor if the virt runner has already submitted an authorization request ext_pillar Syntax salt.pillar.virtkey.ext_pillar( hyper_id, pillar, name, key ) Details Accept the key for the VM on the hyper, if authorized. Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/renderers/all/salt.renderers.cheetah.html","salt.renderers.cheetah","salt.renderers.cheetah Cheetah Renderer for Salt render Syntax salt.renderers.cheetah.render( cheetah_data, saltenv=&#39;base&#39;, sls=&#39;&#39;, method=&#39;xml&#39;, **kws ) Details Render a Cheetah template. Arguments Details Value Description Return type A Python data structure Next Copyright &#169; 2015 SaltStack. ",""],
["ref/renderers/all/salt.renderers.genshi.html","salt.renderers.genshi","salt.renderers.genshi Genshi Renderer for Salt render Syntax salt.renderers.genshi.render( genshi_data, saltenv=&#39;base&#39;, sls=&#39;&#39;, method=&#39;xml&#39;, **kws ) Details Render a Genshi template. A method should be passed in as part of the kwargs. If no method is passed in, xml is assumed. Valid methods are...",""],
...
["ref/rest-api.html","REST API Modules (salt.netapi)","REST API Modules (salt.netapi) rest_cherrypy rest_tornado rest_wsgi Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/roster/all/salt.roster.flat.html","salt.roster.flat","salt.roster.flat Read in the roster from a flat file using the renderer system RosterMatcher Class Syntax salt.roster.flat.RosterMatcher Details Matcher for the roster data structure targets Syntax salt.roster.flat.targets( tgt, tgt_type=&#39;glob&#39;, **kwargs ) Details Return the targets from the fla...",""],
["ref/roster/all/salt.roster.scan.html","salt.roster.scan","salt.roster.scan Scan a netmask or ipaddr for open ssh ports RosterMatcher Class Syntax salt.roster.scan.RosterMatcher Details Matcher for the roster data structure targets Syntax salt.roster.scan.targets( tgt, tgt_type=&#39;glob&#39;, **kwargs ) Details Return the targets from the flat yaml file, check...",""],
...
["ref/sdb.html","SDB (salt.sdb)","SDB (salt.sdb) salt.sdb.etcd_db salt.sdb.keyring_db salt.sdb.memcached salt.sdb.sqlite3 Next Copyright &#169; 2015 SaltStack. ",""],
["ref/ssh-roster.html","SSH Roster Modules (salt.roster)","SSH Roster Modules (salt.roster) salt.roster.ansible salt.roster.cache salt.roster.cloud salt.roster.flat salt.roster.scan Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/states/all/salt.states.apt.html","salt.states.apt","salt.states.apt Package management operations specific to APT- and DEB-based systems held Syntax salt.states.apt.held( name ) Set package in &#39;hold&#39; state, meaning it will not be upgraded. Arguments Name Description name The name of the package, e.g., &#39;tmux&#39; Details Next Copyright &#169; 2015 SaltStac...",""],
...
["ref/states/all/salt.states.cyg.html","salt.states.cyg","salt.states.cyg Installation of Cygwin packages. A state module to manage cygwin packages. Packages can be installed or removed. dos2unix: cyg.installed DictDiffer Class Syntax salt.states.cyg.DictDiffer Details Calculate the difference between two dictionaries. items added items removed keys sa...",""],
...
["ref/states/all/salt.states.disk.html","salt.states.disk","salt.states.disk Disk monitoring state Monitor the state of disk resources status Syntax salt.states.disk.status( name, maximum=None, minimum=None ) Details Return the current disk usage stats for the named mount point Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/states/all/salt.states.hipchat.html","salt.states.hipchat","salt.states.hipchat Send a message to Hipchat This state is useful for sending messages to Hipchat during state runs. hipchat-message: hipchat.send_message: - room_id: 123456 - from_name: SuperAdmin - message: &#39;This state was executed successfully.&#39; - api_key: peWcBiMOS9HrZG15peWcBiMOS9HrZG15 - ...",""],
...
["ref/states/all/salt.states.sysrc.html","salt.states.sysrc","salt.states.sysrc absent Syntax salt.states.sysrc.absent( name, **kwargs ) Ensure a sysrc variable is absent. Arguments Name Description name The variable name to set file (optional) The rc file to add the variable to. jail (option) the name or JID of the jail to set the value in. Details manage...",""],
...
["ref/states/altering_states.html","Altering States","Altering States Note: This documentation has been moved here . Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/states/global_state_arguments.html","Global State Arguments","Global State Arguments Note: This documentation has been moved here . Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/states/overstate.html","OverState System","OverState System Note: This documentation has been moved here . Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/tops.html","Top File Modules (salt.tops)","Top File Modules (salt.tops) salt.tops.cobbler salt.tops.ext_nodes salt.tops.mongo salt.tops.reclass_adapter Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/wheel/all/salt.wheel.minions.html","salt.wheel.minions","salt.wheel.minions Wheel system wrapper for connected minions connected Syntax salt.wheel.minions.connected( ) Details List all connected minions on a salt-master Next Copyright &#169; 2015 SaltStack. ",""],
...
["ref/wheel.html","Wheel Modules (salt.wheel)","Wheel Modules (salt.wheel) salt.wheel.config salt.wheel.error salt.wheel.file_roots salt.wheel.key salt.wheel.minions salt.wheel.pillar_roots Next Copyright &#169; 2015 SaltStack. ",""],
["reference.html","Salt Module Reference Guide","Table of Contents About This Guide Authentication Modules (salt.auth) salt.auth.auto salt.auth.django salt.auth.keystone salt.auth.ldap salt.auth.mysql salt.auth.pam salt.auth.pki salt.auth.stormpath_mod salt.auth.yubico Beacons (salt.beacons) salt.beacons.inotify salt.beacons.journald salt.beac...",""],
["themes/bootstrap/js/ref-toc.html","No title","Get Started Contents User Guide Module Reference About This Guide Authentication Modules (salt.auth) salt.auth.auto salt.auth.django salt.auth.keystone salt.auth.ldap salt.auth.mysql salt.auth.pam salt.auth.pki salt.auth.stormpath_mod salt.auth.yubico Beacons (salt.beacons) salt.beacons.inotify ...",""],
["themes/bootstrap/js/user-toc.html","No title","Get Started Contents Reference Salt User Guide Introduction to Salt Using the Enterprise GUI View Masters View Minions Jobs Targets Console Overview View Reports Architecture Reference Manage Masters Manage Jobs User Accounts Deployment Getting Started System Requirements SaltStack Walk-through ...",""],
...
["topics/installation/architecture.html","Architecture","Architecture Salt Syndic Multi Master Tutorial Multi-Master-PKI Tutorial With Failover Using salt at scale High-Availability Architecture The RAET Transport Next Copyright &#169; 2015 SaltStack. ",""],
...
["topics/installation/gentoo.html","Gentoo","Gentoo Salt can be easily installed on Gentoo via Portage: emerge app-admin/salt Post-installation tasks Now go to the Configuring Salt page. Next Copyright &#169; 2015 SaltStack. ",""],
["topics/installation/high-availability.html","High-Availability Architecture","High-Availability Architecture SaltStack is a very powerful, flexible and widely used infrastructure automation system. This flexibility combined with having an open-source code base allows SaltStack aka &#8220;Salt&#8221; to be used for a wide variety of applications and implementation models. The intentio...",""],
["topics/installation/models.html","Additional Management Configurations","Additional Management Configurations Salt SSH Salt Masterless Quickstart Standalone Minion Next Copyright &#169; 2015 SaltStack. ",""],
...
["topics/targeting/ipcidr.html","Subnet/IP Address Matching","Subnet/IP Address Matching Minions can easily be matched based on IP address, or by subnet (using CIDR notation). salt -S 192.168.40.20 test.ping salt -S 10.0.0.0/24 test.ping Note: Only IPv4 matching is supported at this time. Next Copyright &#169; 2015 SaltStack. ",""],
...
["topics/tutorials/firewall.html","Opening the Firewall up for Salt","Opening the Firewall up for Salt The Salt master communicates with the minions using an AES-encrypted ZeroMQ connection. These communications are done over TCP ports 4505 and 4506, which need to be accessible on the master only. This document outlines suggested firewall rules for allowing these ...",""],
...
["user.html","SaltStack Enterprise Help","Table of Contents Introduction to Salt Using the Enterprise GUI View Masters View Minions Jobs Targets Console Overview View Reports Architecture Reference Manage Masters Manage Jobs User Accounts Deployment Getting Started System Requirements SaltStack Walk-through Preparing the SaltStack Ops S...",""]];

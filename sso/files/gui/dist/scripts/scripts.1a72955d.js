 ...
 */
angular.module('sseFeApp')
    .controller('BeaconsCtrl', [ '$scope', 'SaltBeaconService', 'growl', '$modal', 'fileService', '$state', function($scope, SaltBeaconService, growl, $modal, fileService, $state) {
        ...
        $scope.beaconsChartGlobalOptions = {
            ...
            'options'   : {
                'title'             : 'Logins Per Hour Across System',

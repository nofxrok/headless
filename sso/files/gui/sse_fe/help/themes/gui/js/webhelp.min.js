...
$( document ).ready(function() {
    ...
    if ($( '#sidebar-wrapper.dynamic-toc' ).length) {

        var tocfile;
        if ($( '#sidebar-wrapper.reference' ).length) {
            tocfile = '/help/themes/gui/js/ref-toc.html';
        }
        else tocfile = '/help/themes/gui/js/user-toc.html';
    ...
    else if(!$( '.intro').length) activeTOC();
...
function activeTOC() {
    ...
    if ($toc.length) {
        ...
        $( '.topictitle1' ).first().after(function() {
            ...
            out = '<div class="breadcrumbs"><span class="crumb"><a href="' + $( '#guide-title' ).find( 'a' ).attr("href") + '">'+ $( '#guide-title' ).find( 'a').text() + '</a></span><i class="glyphicon glyphicon-chevron-right"></i>' + out;
